...
void disconnected_screen_init() {
    disconnected_screen.dimensions({LCD_WIDTH,LCD_HEIGHT});
    disconnected_screen.buffer_size(lcd_buffer_size);
    disconnected_screen.buffer1(lcd_buffer1);
    disconnected_screen.buffer2(lcd_buffer2);
    ...
    svg_doc::read(&disconnected_icon_stream,&disconnected_icon);
